...
for commit in commits:
    ...
    # needed for the count of # detected unit tests that are unit tests in the view of the developer
    istqb_dev = 0
    ieee_dev = 0
    without_mock_istqb_dev = 0
    without_mock_ieee_dev = 0
    mock_cutoff_istqb_dev = 0
    mock_cutoff_ieee_dev = 0
